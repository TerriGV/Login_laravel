...
<div class="block mx-auto my-12 p-8 bg-green w-1/3 border border-gree-200
rounded-lg shadow-lg">

  <h1 class="text-3xl text-center font-bold">Registrarce</h1>
  ...
  <form class="mt-4" method="POST" action="">
    ...
    text-white font-semibold p-2 my-3 hover:bg-indigo-600">Registrarce</button>
